        ...
        var colors = ['#00ff00', '#ff0000', '#0000ff', '#800080', '#ff7f00', '#00ffff', '#ffff00'];
...
function drawUI() {
    // background
    g.fillStyle = g.createLinearGradient(0, 0, canvas.width, canvas.height);
    g.fillStyle.addColorStop(0, '#ff7e5f');
    g.fillStyle.addColorStop(1, '#feb47b');
    fillRect(outerRect, g.fillStyle);  // Apply gradient to outer background
    fillRect(gridRect, g.fillStyle);  // Apply gradient to grid background
